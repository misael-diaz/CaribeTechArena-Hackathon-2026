...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-tg+h2z=^z=mk$fou+bxy+ov0df^lb3z_&*mh61iyr=cu9zz$1i')
...
MIDDLEWARE = [
    ...
    'school.middleware.MetricsMiddleware',
]
...
LOGGING = {
    ...
    'handlers': {
        'chat_file': {
            ...
            'filename': BASE_DIR / 'chat_timing.log',
            'formatter': 'verbose',
        },
    },
    'loggers': {
