...
We were presented with the challenge of presenting solutions that would prevent parents from sending their kids to school without credits to buy at the cafeteria and as a consequence of that improve the reveneu of the startup. We also had to make the chatbot that informs parents more useful to parents by improving the nutritional information that they provide and to remind them if the balance is too low. Additionally, we had to turn the administrative dashboard into a Business Intelligence platform.
